...
#HW 1
#AMPL model file for Problem 1-4b
#Advertising
...
subject to Total_Person_Working : tv_minutes * tv_person_weeks + mag_pages * mag_person_weeks <= person_weeks_available;
...
#Print solutions
printf "-----Solution Question 4b: limiting person-weeks available to %d----- \n", person_weeks_available;
