...
#initial best solution of each beam
for i in range (1, k+1):
    ...
    p_curr = p_value + p_weight
    
    #added initial solutions
    x_bestSolutions.append(x_curr) 
    f_bestSolutions.append(f_curr)
    p_bestSolutions.append(p_curr)
    ...
    for i in range (1,k+1):
        ...
        while done == 0:                
            ...
            for s in Neighborhood:                #evaluate every member in the neighborhood of x_curr
                ...
                #collect neighborhood solutionsa
                f_s_curr = evaluate(s)[:]
                all_f_solutions.append(f_s_curr)
                ...
                if f_s_curr[0] > 0: #probability for feasible solution 
                    ...
                    p_s_curr = 0
                #add current probability to the list    
                all_p_solutions.append(p_s_curr)

                if f_s_curr[0] > f_best[0]:    
...
#print solutions
print ("\n--------SOLUTIONS PROBLEM 7 - STOCHASTIC BEAM SEARCH--------")    
print ("k-value: ", k)
